/**
 * @file TestBufferWriterReplicate.h
...
#include "../../dfi/memory/BufferWriterReplicate.h"
#include "../../dfi/memory/BufferReader.h"

#include <atomic>

class TestBufferWriterReplicate : public testing::Test  {
...
class BufferWriterReplicateClient : public rdma::Thread
{
...
public: 
  ...
  BufferWriterReplicateClient(NodeServer* nodeServer, string& bufferName, std::vector<DataType> *dataToWrite) : 
  ...
  void run() 
  {
    ...
    BufferWriterReplicate buffWriter({buffername}, registry_client, Config::DFI_SOURCE_SEGMENT_COUNT);
